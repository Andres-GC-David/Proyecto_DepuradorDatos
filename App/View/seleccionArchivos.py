...
class Ui_Dialog(object):
    ...
    def setupUi(self, Dialog):
        ...
        self.fileSelectionWindowLabel.setGeometry(QtCore.QRect(30, 40, 300, 30))  
        font = QtGui.QFont()
    ...
    def add_file_to_main_window(self, dialog: QtWidgets.QDialog):
        ...
        if self.selected_file_path:
            ...
            self.main_window.summayOfDataTable.setItem(0, 2, QtWidgets.QTableWidgetItem(self.selected_file_path)) 
    ...
    def open_file_dialog(self):
        ...
        if file_path:
            ...
            self.fileSelectedLabel.setText(file_path.split("/")[-1])  
            
            
    def open_manage_file_types_dialog(self):
        manage_file_types_dialog = ManageFileTypesDialog(self.main_window)  
